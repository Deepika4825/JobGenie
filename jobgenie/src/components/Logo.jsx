    ...
    <div className={`flex items-center gap-2 ${className}`}>
      ...
      {showText && (
        <div className="flex flex-col leading-none">
          <span className="font-extrabold tracking-wide" style={{ fontSize: size * 0.45, color: 'var(--rose-purple)' }}>
            JOB GENIE
          </span>
          <span className="font-semibold tracking-widest" style={{ fontSize: size * 0.22, color: 'var(--rose-secondary)' }}>
            HIRE SMARTER
          </span>
        </div>
      )}
